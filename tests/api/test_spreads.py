...
from api.spreads import get_spread, get_spreads, SpreadResponseModel
...
class TestSpreads(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_spread(self):
        ...
        with patch('api.spreads.calculate_spread', mock_calculate_spread):
            ...
            self.assertEqual(result, SpreadResponseModel(market= market, spread= 0.05))
    ...
    async def test_get_spreads(self):
        ...
        with patch('api.spreads.get_all_markets', mock_get_all_markets), \
            ...
            expected_result = [SpreadResponseModel(market= "BTC-CLP", spread= 0.05), SpreadResponseModel(market= "ETH-BTC", spread= 0.05)]
